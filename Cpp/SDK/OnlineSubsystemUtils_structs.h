...
struct FPlayerReservation
{
	...
	unsigned char                                      UnknownData_NCYQ[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FPartyReservation
{
	...
	unsigned char                                      UnknownData_FG2K[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_XDDD[0xE0];                                    // 0x0000(0x00E0) MISSED OFFSET (PADDING)
