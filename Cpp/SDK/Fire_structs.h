...
struct FReplicatedFireCellCharringData
{
	...
	unsigned char                                      UnknownData_2R7X[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireGridCharringManager
{
	...
	unsigned char                                      UnknownData_LHBV[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UCAC[0xA0];                                    // 0x0028(0x00A0) MISSED OFFSET (PADDING)
...
struct FShipFireLightRelativeSpawnDesc : public FFireGridRelativeSpawnDesc
{
	...
	unsigned char                                      UnknownData_POSA[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FShipFireLight
{
	...
	unsigned char                                      UnknownData_S06D[0x20];                                    // 0x0070(0x0020) MISSED OFFSET (PADDING)
...
struct FShipFireLightManager
{
	...
	unsigned char                                      UnknownData_78EE[0x4];                                     // 0x0114(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_API6[0x18];                                    // 0x0128(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WS9A[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q8U2[0x10];                                    // 0x0038(0x0010) MISSED OFFSET (PADDING)
...
struct FFireCellStateParticleTemplate
{
	...
	unsigned char                                      UnknownData_8MJZ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RVZR[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RFZ9[0x2];                                     // 0x0036(0x0002) MISSED OFFSET (PADDING)
...
struct FFireCellDesc
{
	...
	unsigned char                                      UnknownData_97CA[0x1];                                     // 0x0037(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6J0T[0xF];                                     // 0x0041(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireParticleSpawnData
{
	...
	unsigned char                                      UnknownData_L835[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FFireParticleSpawnList
{
	...
	unsigned char                                      UnknownData_WMDH[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FFireDefaultVFXSpawnData
{
	...
	unsigned char                                      UnknownData_NVU2[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireGridCellSelection
{
	...
	unsigned char                                      UnknownData_N9Y2[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireParticleSystem
{
	...
	unsigned char                                      UnknownData_ZKGK[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireMesh
{
	...
	unsigned char                                      UnknownData_2ID5[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FActorFireDamageParams
{
	...
	unsigned char                                      UnknownData_A5HX[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_7Q3U[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7AAE[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EJ64[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8TS0[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_D5T8[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
