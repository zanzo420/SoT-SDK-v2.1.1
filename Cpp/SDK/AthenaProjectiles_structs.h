...
struct FThrottledProjectileTickPool
{
	...
	unsigned char                                      UnknownData_1CQB[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGlobalProjectileSettings
{
	...
	unsigned char                                      UnknownData_512K[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
