...
public:
	...
	unsigned char                                      UnknownData_4UCE[0x20];                                    // 0x0028(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       DefaultBody;                                               // 0x0060(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_Z3ZA[0x20];                                    // 0x0060(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	unsigned char                                      UnknownData_AC2J[0x28];                                    // 0x0430(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RN5O[0x88];                                    // 0x0470(0x0088) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8A63[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HWPT[0x14E];                                   // 0x00EA(0x014E) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_G7FE[0x10];                                    // 0x07D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YAL1[0x54];                                    // 0x07FC(0x0054) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K19R[0x118];                                   // 0x0868(0x0118) MISSED OFFSET (PADDING)
