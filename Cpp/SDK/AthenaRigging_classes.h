...
public:
	...
	unsigned char                                      UnknownData_E64Z[0xB4];                                    // 0x056C(0x00B4) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_UJU6[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2L9B[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EAVA[0x88];                                    // 0x04F8(0x0088) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_F84X[0x8];                                     // 0x02E8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4BSU[0x8];                                     // 0x05F0(0x0008) Fix Super Size
