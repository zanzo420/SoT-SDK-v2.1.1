...
{
public:
	unsigned char                                      UnknownData_BDJG[0x8];                                     // 0x0438(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HUD6[0x2];                                     // 0x0446(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4BN5[0x2];                                     // 0x045A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_70SC[0x4];                                     // 0x0464(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_74NS[0x3C];                                    // 0x04BC(0x003C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_70Y1[0x38];                                    // 0x0028(0x0038) MISSED OFFSET (PADDING)
