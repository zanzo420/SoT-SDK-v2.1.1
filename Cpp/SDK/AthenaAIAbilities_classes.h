...
{
public:
	unsigned char                                      UnknownData_X59V[0x10];                                    // 0x0078(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class AActor*                                      HealAreaOfEffectActor;                                     // 0x0088(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_G766[0x10];                                    // 0x0090(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9WYK[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MP5B[0x7];                                     // 0x00E1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9CIE[0x70];                                    // 0x00F0(0x0070) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_R4DR[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RFFK[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_K0DZ[0x38];                                    // 0x00C8(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_A2TG[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
