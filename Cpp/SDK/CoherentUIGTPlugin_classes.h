...
public:
	...
	unsigned char                                      UnknownData_FU97[0x48];                                    // 0x0158(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YD4M[0x176];                                   // 0x01CA(0x0176) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KC7O[0x3];                                     // 0x0359(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_580C[0x17];                                    // 0x0361(0x0017) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_BCFD[0x18];                                    // 0x00E0(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_F5YP[0x8];                                     // 0x00F8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_S1Z7[0x50];                                    // 0x0430(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9VLA[0x80];                                    // 0x0028(0x0080) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_GTV5[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JC2X[0x8];                                     // 0x0360(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FQ7C[0x90];                                    // 0x0530(0x0090) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_X8T1[0x20];                                    // 0x0470(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_C59U[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UFVN[0x1];                                     // 0x003F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K0Z9[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Z6EI[0x20];                                    // 0x0138(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HOYK[0x48];                                    // 0x01E0(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W3YY[0x3];                                     // 0x022D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6NAR[0x1A3];                                   // 0x024D(0x01A3) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GJ9B[0x3];                                     // 0x0405(0x0003) MISSED OFFSET (PADDING)
