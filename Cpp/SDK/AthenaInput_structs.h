...
struct FNotificationInputDisplayName
{
	...
	unsigned char                                      UnknownData_C46P[0x20];                                    // 0x0008(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FIdleTimeTracker
{
	...
	unsigned char                                      UnknownData_XWHI[0x30];                                    // 0x0008(0x0030) MISSED OFFSET (PADDING)
...
struct FPrioritizedCompositeInputHandler
{
	...
	unsigned char                                      UnknownData_BG5N[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FCompositeInputDelegator
{
	...
	unsigned char                                      UnknownData_NM3V[0x50];                                    // 0x0010(0x0050) MISSED OFFSET (PADDING)
