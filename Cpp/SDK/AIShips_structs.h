...
struct FAIShipBattleParams
{
	...
	unsigned char                                      UnknownData_FBZF[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_XY6D[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FTrackingNoiseGenerator
{
	...
	unsigned char                                      UnknownData_A2Q5[0xC];                                     // 0x000C(0x000C) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterParamsSpawnerData
{
	...
	unsigned char                                      UnknownData_7LA1[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipContextDescDamageParams
{
	...
	unsigned char                                      UnknownData_VKFL[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2HHB[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipCrewFormType
{
	...
	unsigned char                                      UnknownData_0FI9[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8GP8[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipCrewAmmoType
{
	...
	unsigned char                                      UnknownData_XASO[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedAIShipCrewFormType
{
	...
	unsigned char                                      UnknownData_HRER[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	int                                                Weight;                                                    // 0x0000(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_KCM1[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipGenerationParams
{
	...
	unsigned char                                      UnknownData_RY3I[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J3P1[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FAIShipWeightedSize
{
	...
	unsigned char                                      UnknownData_JYQF[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipSizeLimit
{
	...
	unsigned char                                      UnknownData_4YR0[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterBattleGenerationParams
{
	...
	unsigned char                                      UnknownData_GZEF[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFeatureLockedAIShipEncounterBattleGenerationParams
{
	...
	unsigned char                                      UnknownData_RB1L[0x10];                                    // 0x0068(0x0010) MISSED OFFSET (PADDING)
...
struct FAIShipBattleEncounterDescGenerationParams
{
	...
	unsigned char                                      UnknownData_T3R8[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedSpawnOffset
{
	...
	unsigned char                                      UnknownData_BEK6[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedSpawnDirection
{
	...
	float                                              Weight;                                                    // 0x0008(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_RNCN[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FWeightedSpawnOffset>                SpawnOffsets;                                              // 0x0010(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	unsigned char                                      UnknownData_LPCM[0x90];                                    // 0x0020(0x0090) MISSED OFFSET (PADDING)
...
struct FRelativeSpawnLocationGeneratorParams
{
	...
	unsigned char                                      UnknownData_XHKP[0x90];                                    // 0x0010(0x0090) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterParams
{
	...
	unsigned char                                      UnknownData_OKHU[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FText                                       Name;                                                      // 0x0000(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_PLKH[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       SkellyCrewName;                                            // 0x0038(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_64W3[0x20];                                    // 0x0038(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_0T5M[0x6];                                     // 0x0072(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipDespawnedEvent
{
	...
	unsigned char                                      UnknownData_HJV7[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FAIShipSpawnedEvent
{
	...
	unsigned char                                      UnknownData_S0LP[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterCompleteNetEvent : public FBoxedRpc
{
	...
	unsigned char                                      UnknownData_TJNP[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterRevealNetEvent : public FBoxedRpc
{
	...
	unsigned char                                      UnknownData_IZNB[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterNotification
{
	...
	unsigned char                                      UnknownData_8WK7[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_FYCR[0x20];                                    // 0x0040(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_ZEF2[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterZoneEnteredNetworkEvent : public FNetworkEventStruct
{
	...
	unsigned char                                      UnknownData_T0EE[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIShipDamagedTelemetryEvent
{
	...
	unsigned char                                      UnknownData_EGSX[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ELN6[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FAIShipDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_1Y0B[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FAIShipSpawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_P8PM[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
