...
public:
	...
	unsigned char                                      UnknownData_9O95[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_687M[0x18];                                    // 0x0110(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9F08[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
