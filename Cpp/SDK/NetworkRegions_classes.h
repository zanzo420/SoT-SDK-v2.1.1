...
{
public:
	unsigned char                                      UnknownData_SIVG[0x90];                                    // 0x0028(0x0090) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_M3S6[0x20];                                    // 0x0450(0x0020) MISSED OFFSET (PADDING)
