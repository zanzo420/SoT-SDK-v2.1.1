...
{
	unsigned char                                      UnknownData_W2MP[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FSlateColor
{
	...
	unsigned char                                      UnknownData_2J94[0x1F];                                    // 0x0011(0x001F) MISSED OFFSET (PADDING)
...
struct FSlateBrush
{
	...
	unsigned char                                      UnknownData_P5GY[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZSFA[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V0QN[0x5];                                     // 0x0063(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IL0C[0x2];                                     // 0x007A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInlineTextImageStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_1J4K[0x6];                                     // 0x009A(0x0006) MISSED OFFSET (PADDING)
...
struct FSlateFontInfo
{
	...
	unsigned char                                      UnknownData_8JOC[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KLMY[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FSearchBoxStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_C6UP[0x7];                                     // 0x0AF9(0x0007) MISSED OFFSET (PADDING)
...
struct FSlateSound
{
	...
	unsigned char                                      UnknownData_BPAY[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FCheckBoxStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_JRC2[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInputEvent
{
	unsigned char                                      UnknownData_Y8N5[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9GAW[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8ECN[0x30];                                    // 0x0028(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1QCP[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6UBE[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_33HS[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YU1S[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FFocusEvent
{
	unsigned char                                      UnknownData_UUJ7[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FFontData
{
	...
	unsigned char                                      UnknownData_IMSQ[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCompositeSubFont
{
	...
	unsigned char                                      UnknownData_N9N7[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FCompositeFont
{
	...
	unsigned char                                      UnknownData_CXJT[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
...
struct FDockTabStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_FXI4[0x4];                                     // 0x06B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_KZVI[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
struct FGeometry
{
	unsigned char                                      UnknownData_H12T[0x34];                                    // 0x0000(0x0034) MISSED OFFSET (PADDING)
