...
{
public:
	unsigned char                                      UnknownData_OCK2[0x58];                                    // 0x00C8(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SY1F[0x1];                                     // 0x012F(0x0001) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_79W1[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_78BT[0x30];                                    // 0x00E0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OQSV[0x8];                                     // 0x0120(0x0008) MISSED OFFSET (PADDING)
