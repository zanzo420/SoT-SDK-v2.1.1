...
struct FAthenaAIFormComponentVfxCustomisation
{
	...
	unsigned char                                      UnknownData_GV4H[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAISpawnTypeParams
{
	...
	unsigned char                                      UnknownData_6H5W[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_IKGU[0x4];                                     // 0x0060(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_VRB3[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       LocalisableName;                                           // 0x00B0(0x0018) ELEMENT_SIZE_MISMATCH (Edit)
	unsigned char                                      UnknownData_ZQH4[0x20];                                    // 0x00AC(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UnknownData_DZPN[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FWeightedAISpawnTypeParams>          SpawnParams;                                               // 0x0008(0x0010) (Edit, ZeroConstructor)
	unsigned char                                      UnknownData_RS2Z[0x30];                                    // 0x0018(0x0030) MISSED OFFSET (PADDING)
...
struct FAISpawnContextIdEncounterSettingsPair
{
	...
	unsigned char                                      UnknownData_G938[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAdditionalSpawnerBehaviour
{
	...
	unsigned char                                      UnknownData_B658[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FAIFormDamageResponse
{
	...
	unsigned char                                      UnknownData_HCAK[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (PADDING)
...
struct FAthenaAIAbilityPlayerBasedRange
{
	...
	unsigned char                                      UnknownData_TSPM[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIAbilityFollowUp
{
	...
	unsigned char                                      UnknownData_3GIW[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FAttackableTypeToAnimMapping
{
	...
	unsigned char                                      UnknownData_Y7X3[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QXRA[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAISpawnerWave
{
	...
	unsigned char                                      UnknownData_LDSU[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIPersistentSpawnerWave : public FAISpawnerWave
{
	...
	unsigned char                                      UnknownData_NJ64[0x17];                                    // 0x0101(0x0017) MISSED OFFSET (PADDING)
...
struct FAIBountySpawnerWave : public FAIPersistentSpawnerWave
{
	...
	unsigned char                                      UnknownData_YTLJ[0x4];                                     // 0x011C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U2JZ[0x38];                                    // 0x0128(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIBountySpawnerWaveGroup
{
	...
	unsigned char                                      UnknownData_B3TP[0x14];                                    // 0x0014(0x0014) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PK8K[0x10];                                    // 0x0100(0x0010) MISSED OFFSET (PADDING)
...
struct FAthenaAIControllerSenseSettings
{
	...
	unsigned char                                      UnknownData_WIOS[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAthenaAIControllerSenseSettingOverride
{
	...
	unsigned char                                      UnknownData_NXO9[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FAthenaAIControllerHealthCustomisation
{
	...
	unsigned char                                      UnknownData_0J87[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAthenaAIItemParamValue
{
	...
	unsigned char                                      UnknownData_V4RK[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_Y58N[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FAthenaAICharacterControllerWeightedAmmoType
{
	...
	unsigned char                                      UnknownData_YCEM[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIDebugVisualisationLine
{
	...
	unsigned char                                      UnknownData_6DSL[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDebugVisualisationBox
{
	...
	unsigned char                                      UnknownData_2VBJ[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UQVK[0xB];                                     // 0x0035(0x000B) MISSED OFFSET (PADDING)
...
struct FAIDebugVisualisationCylinder
{
	...
	unsigned char                                      UnknownData_7T7O[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDebugVisualisationSphere
{
	...
	unsigned char                                      UnknownData_HGOV[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDebugVisualisationCone
{
	...
	unsigned char                                      UnknownData_GPFH[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FAIIndividualVarietyEntry
{
	...
	unsigned char                                      UnknownData_NKET[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIDropSpawnerRankMapping
{
	...
	unsigned char                                      UnknownData_44ZN[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FAITypeData
{
	...
	unsigned char                                      UnknownData_5Q31[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AVBJ[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FCustomPlayersAITrackerData
{
	...
	unsigned char                                      UnknownData_H1EX[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
struct FAIEncounterSpecification
{
	...
	unsigned char                                      UnknownData_XGX7[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_VMYF[0x4];                                     // 0x0050(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_0XT2[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       LocalisableName;                                           // 0x0080(0x0018) ELEMENT_SIZE_MISMATCH
	unsigned char                                      UnknownData_VB0O[0x20];                                    // 0x007C(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_X6MR[0x3];                                     // 0x00C5(0x0003) MISSED OFFSET (PADDING)
...
struct FEventAIStartedDeadActionState
{
	...
	unsigned char                                      UnknownData_5DOB[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEventPawnFinishedDying
{
	...
	unsigned char                                      UnknownData_PEKJ[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FEventPawnStartedDying
{
	class APawn*                                       AIPawn;                                                    // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<Athena_ECharacterDeathType>            DeathType;                                                 // 0x0008(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_YLA5[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	TEnumAsByte<Athena_ECharacterDeathType>            DeathType;                                                 // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_B6ZW[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBountySpawnerTargetDesc
{
	...
	unsigned char                                      UnknownData_WYJK[0x16];                                    // 0x0002(0x0016) MISSED OFFSET (PADDING)
...
struct FAIBountySpawnerWaveLocation
{
	...
	unsigned char                                      UnknownData_ABNX[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2I2A[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FAIBountySpawnerArchive : public FAISpawnerArchive
{
	...
	unsigned char                                      UnknownData_20MW[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JMNC[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FBountySpawnerAudioChangedNetworkEvent : public FNetworkEventStruct
{
	...
	unsigned char                                      UnknownData_0U5B[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E1NC[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEventAIBountySpawnerTargetKilled
{
	...
	unsigned char                                      UnknownData_E562[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_J3VJ[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_7VIQ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WL1R[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FAIFixedWavesSpawnerArchive : public FAISpawnerArchive
{
	...
	unsigned char                                      UnknownData_574E[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7M19[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_R1Q2[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FAICustomNameTitleMapping
{
	...
	unsigned char                                      UnknownData_A5MW[0x20];                                    // 0x0008(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	int                                                CurrentWaveIndex;                                          // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_K02L[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_546K[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FSirenEncounterData
{
	...
	unsigned char                                      UnknownData_NIX0[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FWeightedAmmoType
{
	...
	unsigned char                                      UnknownData_ZZQL[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedAmmoTypeRange
{
	...
	unsigned char                                      UnknownData_9NE4[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAthenaAIControllerTargetPickingData
{
	...
	unsigned char                                      UnknownData_RPZ1[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIStategyControllerMovementMod
{
	...
	unsigned char                                      UnknownData_ENQ6[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FCarriedItemThreatOverride
{
	...
	unsigned char                                      UnknownData_L0AF[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FBlackboardValueCondition
{
	...
	unsigned char                                      UnknownData_CV2L[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OIFU[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (PADDING)
...
struct FConditionalBasedOnBlackboardKey
{
	...
	unsigned char                                      UnknownData_IGJB[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GQAP[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SWOE[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6GD6[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_O21Q[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_86D2[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1I32[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_F0T1[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4JUY[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YW04[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ND6Z[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_890B[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4HEV[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventAILoadoutSelected
{
	...
	unsigned char                                      UnknownData_1B60[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9VPB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventOwnedPawnFinishedSpawning
{
	...
	unsigned char                                      UnknownData_30P3[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y4VF[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	class AActor*                                      Player;                                                    // 0x0000(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_JXMN[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
{
	class AActor*                                      Player;                                                    // 0x0000(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_KDJ9[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
{
	class AActor*                                      Player;                                                    // 0x0000(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_SQCN[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
{
	class AActor*                                      Player;                                                    // 0x0000(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_GPTG[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_S3Y0[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventAIPawnRemovedFromAIRegion
{
	...
	unsigned char                                      UnknownData_6ZGD[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	class APawn*                                       AIPawn;                                                    // 0x0000(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_IJ8X[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FAIActorTimeout
{
	...
	unsigned char                                      UnknownData_B273[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIDioramaPawn
{
	...
	unsigned char                                      UnknownData_TS9Y[0x40];                                    // 0x0008(0x0040) MISSED OFFSET (PADDING)
...
struct FAIDioramaLocationSourceComponentData
{
	...
	unsigned char                                      UnknownData_D9G9[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
struct FDioramaCategoryEntries
{
	...
	unsigned char                                      UnknownData_4GE1[0x50];                                    // 0x0050(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_C0FP[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FTinySharkParams
{
	...
	unsigned char                                      UnknownData_N2MO[0x4];                                     // 0x0018(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_4BGY[0x4];                                     // 0x0038(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_Q07E[0x4];                                     // 0x0058(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UnknownData_3HOR[0x48];                                    // 0x0000(0x0048) MISSED OFFSET (PADDING)
...
struct FTinySharkServiceParams
{
	...
	unsigned char                                      UnknownData_64X4[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_R1K2[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FTinySharkDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_0S0B[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FPetTurnRateModifier
{
	...
	unsigned char                                      UnknownData_11SE[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FPetFlyingStrategyProperties
{
	...
	unsigned char                                      UnknownData_S4IV[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FPetMovementRequest
{
	...
	unsigned char                                      UnknownData_CA41[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_43PY[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FPetLoadedMaterial
{
	...
	unsigned char                                      UnknownData_4B9X[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FPetPartSizeMapping
{
	...
	unsigned char                                      UnknownData_OL2N[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPetMaterialEntry
{
	...
	unsigned char                                      UnknownData_VSZQ[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
