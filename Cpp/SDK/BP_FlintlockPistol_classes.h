...
{
public:
	unsigned char                                      UnknownData_TC0H[0x4];                                     // 0x0A7C(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_C58L[0x7];                                     // 0x0A91(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
