...
public:
	...
	unsigned char                                      UnknownData_NKV1[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5D87[0x3];                                     // 0x0469(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FVector                                     EndOfSlideLaunchForce;                                     // 0x046C(0x000C) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected)
	unsigned char                                      UnknownData_9O7O[0x28];                                    // 0x0478(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QEIQ[0x30];                                    // 0x01D8(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_66MN[0x8];                                     // 0x00E0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FLJY[0x14];                                    // 0x00FC(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
