...
{
public:
	unsigned char                                      UnknownData_2FT0[0x28];                                    // 0x0478(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WAFX[0x8];                                     // 0x0438(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8GZD[0x10];                                    // 0x0430(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TZKM[0x50];                                    // 0x0458(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_S8NR[0x10];                                    // 0x0560(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GB25[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_E6J5[0x28];                                    // 0x00C8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_YILV[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XYZ0[0x20];                                    // 0x0580(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WT3Q[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_961O[0x4];                                     // 0x0104(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FWaterSpout>                         ActiveWaterSpouts;                                         // 0x0108(0x0010) (ZeroConstructor, ContainsInstancedReference)
	unsigned char                                      UnknownData_PITO[0x18];                                    // 0x0118(0x0018) MISSED OFFSET (PADDING)
