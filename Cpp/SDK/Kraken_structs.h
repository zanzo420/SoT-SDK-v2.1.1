...
struct FKrakenShipWrappingBehaviourNamedTransform
{
	...
	unsigned char                                      UnknownData_H8IV[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWarningParams
{
	...
	unsigned char                                      UnknownData_F6RP[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P9J4[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenDynamicsStateEvent
{
	...
	unsigned char                                      UnknownData_UVIV[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenDynamicsStateFragmentParams
{
	...
	unsigned char                                      UnknownData_OPJN[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWrapLocationParams
{
	...
	unsigned char                                      UnknownData_37TW[0xC];                                     // 0x0014(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWrapLocationWeightedParams
{
	...
	unsigned char                                      UnknownData_EYQ7[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWrapParams
{
	...
	unsigned char                                      UnknownData_I0KN[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1Q7C[0xC];                                     // 0x0054(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourHeavyAttackParams
{
	...
	unsigned char                                      UnknownData_2GO7[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingBehaviourDamageParams
{
	...
	unsigned char                                      UnknownData_5RHW[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourHealthParams
{
	...
	unsigned char                                      UnknownData_S68I[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingBehaviourParams
{
	...
	unsigned char                                      UnknownData_2U7E[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenBehaviourParams
{
	...
	unsigned char                                      UnknownData_5G57[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenAnimatedTentacleTransitionAnimation
{
	...
	unsigned char                                      UnknownData_C260[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenAnimatedTentacleStateAnimationMapping
{
	...
	unsigned char                                      UnknownData_JD6O[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentacleBehaviourActionChances
{
	...
	unsigned char                                      UnknownData_RUOY[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentacleBehaviourParams
{
	...
	unsigned char                                      UnknownData_MNJS[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VWG3[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenPlayerGrabbingHoldingStateTransitionChance
{
	...
	unsigned char                                      UnknownData_Z0MV[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenPlayerGrabbingBehaviourParams : public FKrakenTentacleBehaviourParams
{
	...
	unsigned char                                      UnknownData_WT47[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenServiceSpawnParams
{
	...
	unsigned char                                      UnknownData_OX7E[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCoordinatedKrakenPhaseAssetEntry
{
	...
	unsigned char                                      UnknownData_826A[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8CGA[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_A7MF[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K1WB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZOTR[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_34NW[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MAVU[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GPJ3[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_W8BC[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MPLV[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6B85[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4FK0[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9M4P[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y0JG[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZYIN[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventKrakenAnimatedTentacleAnimationStarted
{
	...
	unsigned char                                      UnknownData_GSU0[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LSIU[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IDRS[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NX7N[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FKrakenDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_SSEC[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenSpecialEvent
{
	...
	unsigned char                                      UnknownData_1PAR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              TimeOffset;                                                // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_QWAX[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenTentacleAction
{
	...
	unsigned char                                      UnknownData_98EJ[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenHeadAction
{
	...
	unsigned char                                      UnknownData_2TO9[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenExplosionEvent
{
	...
	float                                              TimeOffset;                                                // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_Y9G0[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenAction
{
	...
	unsigned char                                      UnknownData_ERSK[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingTentacleAnimationStateParams
{
	...
	unsigned char                                      UnknownData_BRQB[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingTentacleVFXParams
{
	...
	unsigned char                                      UnknownData_HDHF[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingTentacleParams
{
	...
	unsigned char                                      UnknownData_HZ4H[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingTentacleAnimationState
{
	...
	unsigned char                                      UnknownData_GDTE[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentaclesChanceParams
{
	...
	unsigned char                                      UnknownData_DM39[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentacleParams
{
	...
	unsigned char                                      UnknownData_TZU3[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenWeightedBehaviour
{
	...
	unsigned char                                      UnknownData_R82J[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FKrakenParams
{
	...
	unsigned char                                      UnknownData_C6VS[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SISR[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (PADDING)
...
{
	int                                                Weight;                                                    // 0x0000(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_J5YU[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4Z42[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FWeightedProbabilityRangeOfRanges           NumZonesToDamage;                                          // 0x0068(0x0030) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_DCGO[0x8];                                     // 0x0098(0x0008) MISSED OFFSET (PADDING)
...
struct FKrakenShipHittingBehaviourParams
{
	...
	unsigned char                                      UnknownData_D7ZZ[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
