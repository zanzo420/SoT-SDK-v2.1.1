...
{
public:
	unsigned char                                      UnknownData_Z8L4[0x8];                                     // 0x0A30(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JX66[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
