...
{
public:
	unsigned char                                      UnknownData_N9MW[0x20];                                    // 0x0430(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HS68[0xFC];                                    // 0x046C(0x00FC) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LMFA[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_50DA[0x4];                                     // 0x0454(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PDUP[0x68];                                    // 0x0468(0x0068) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YFHE[0x70];                                    // 0x06E8(0x0070) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TOE5[0x108];                                   // 0x00C8(0x0108) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FT1H[0x18];                                    // 0x0430(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2KVZ[0x14];                                    // 0x044C(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MFW3[0x1A7];                                   // 0x0469(0x01A7) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class AMurk*                                       MurkActor;                                                 // 0x0610(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash)
	unsigned char                                      UnknownData_UUZH[0xA0];                                    // 0x0618(0x00A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1N4M[0x10];                                    // 0x06E0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BVGL[0x11C];                                   // 0x0854(0x011C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4ULS[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              AnimationPlayRateScale;                                    // 0x0040(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_HN1E[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_Y03D[0x4];                                     // 0x0028(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	unsigned char                                      UnknownData_YQ22[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W6ZL[0x4];                                     // 0x046C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F4DT[0x4];                                     // 0x0484(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SSZ7[0x4];                                     // 0x04A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JHR7[0xC0];                                    // 0x0510(0x00C0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CRMB[0x20];                                    // 0x05D8(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_STJS[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FKrakenServiceParams                        KrakenServiceParams;                                       // 0x0438(0x00A0) (Transient, Protected)
	unsigned char                                      UnknownData_CNV6[0xA0];                                    // 0x04D8(0x00A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class AKraken*                                     Kraken;                                                    // 0x0578(0x0008) (Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_ETB2[0xD0];                                    // 0x0580(0x00D0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TSSZ[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_3TTG[0x38];                                    // 0x0318(0x0038) MISSED OFFSET (PADDING)
