...
public:
	...
	unsigned char                                      UnknownData_U8FD[0x2F];                                    // 0x0431(0x002F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZX2T[0x3];                                     // 0x0471(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZTL2[0x2];                                     // 0x047A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_53GD[0x4];                                     // 0x0484(0x0004) MISSED OFFSET (PADDING)
