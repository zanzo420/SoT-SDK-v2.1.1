...
public:
	...
	unsigned char                                      UnknownData_M317[0x50];                                    // 0x0100(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OUSG[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GXVX[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_33FA[0x48];                                    // 0x0468(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BDRY[0x28];                                    // 0x0040(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_U8RS[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7Z2O[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
