...
struct FCharacterAnimationIKUpdateParams
{
	...
	unsigned char                                      UnknownData_T0KL[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2T8W[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       ParentBone;                                                // 0x0034(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_VHEF[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FLimbIK
{
	unsigned char                                      UnknownData_VWCI[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8DAD[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_E697[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimationDataStoreAssetWeakReferenceEntry
{
	...
	unsigned char                                      UnknownData_553V[0x4];                                     // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FTransformBlendCurve
{
	...
	unsigned char                                      UnknownData_QJTG[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QBM4[0x7];                                     // 0x0179(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DN0T[0x7];                                     // 0x02F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FRuntimeVectorCurve                         ScaleCurve;                                                // 0x02F8(0x0170) (Edit)
	unsigned char                                      UnknownData_BGQH[0x8];                                     // 0x0468(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UZAD[0x30];                                    // 0x04D0(0x0030) MISSED OFFSET (PADDING)
...
struct FDockableInfo
{
	...
	unsigned char                                      UnknownData_F98D[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FDocker
{
	unsigned char                                      UnknownData_YDB3[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FActorVelocityData
{
	...
	unsigned char                                      UnknownData_IPDZ[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedAnimationData
{
	...
	unsigned char                                      UnknownData_430E[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GIW8[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_45YU[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_D2KL[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventHitReactAnimationRequested
{
	...
	unsigned char                                      UnknownData_P9LC[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FHitReactionAnimationState
{
	...
	unsigned char                                      UnknownData_JWEI[0x1E];                                    // 0x000A(0x001E) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9LOF[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2IZ1[0x77];                                    // 0x0021(0x0077) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7LZU[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FAnimNode_WeightedLoadOnDemandSquencePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_7220[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YFZH[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QN00[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H8N4[0xC];                                     // 0x0000(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LV4Z[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FCustomAnimationMontageStateMachine
{
	...
	unsigned char                                      UnknownData_3YTF[0xC0];                                    // 0x0018(0x00C0) MISSED OFFSET (PADDING)
