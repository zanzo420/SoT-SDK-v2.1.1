...
{
public:
	unsigned char                                      UnknownData_HI40[0x28];                                    // 0x00C8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class ADebugMenu*                                  DebugMenuInstance;                                         // 0x00F0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_XC7U[0x20];                                    // 0x00F8(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9J5I[0x60];                                    // 0x0430(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V13P[0x8];                                     // 0x0118(0x0008) MISSED OFFSET (PADDING)
