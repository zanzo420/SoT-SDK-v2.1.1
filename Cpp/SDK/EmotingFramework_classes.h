...
{
public:
	unsigned char                                      UnknownData_HA86[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5ME4[0x110];                                   // 0x0460(0x0110) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OQMG[0x118];                                   // 0x0430(0x0118) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KZ4M[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
