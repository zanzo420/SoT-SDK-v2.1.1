...
struct FPerComanyItemQualityEntry
{
	...
	unsigned char                                      UnknownData_918Y[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FComplexItemQualityEntry
{
	...
	unsigned char                                      UnknownData_DI7Y[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
