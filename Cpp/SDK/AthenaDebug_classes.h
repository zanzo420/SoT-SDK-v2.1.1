...
{
public:
	unsigned char                                      UnknownData_6OV7[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V4FS[0x80];                                    // 0x04A8(0x0080) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ADR6[0xC];                                     // 0x044C(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_F655[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
