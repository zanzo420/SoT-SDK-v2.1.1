...
struct FEmissaryEventAward
{
	...
	unsigned char                                      UnknownData_B3G4[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEmissaryKillPlayerReward
{
	...
	unsigned char                                      UnknownData_AS4J[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEmissaryGameEventsReward
{
	...
	unsigned char                                      UnknownData_QWHG[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FEmissaryCompanyActionReward
{
	...
	unsigned char                                      UnknownData_I5IR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_W3CD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FUpdateEmissaryValueForCompany
{
	...
	unsigned char                                      UnknownData_RLUT[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDeactivateEmissaryForCrew
{
	...
	unsigned char                                      UnknownData_T2MR[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_5F60[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GZC5[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEmissaryRoleplayActionTelemetryEvent
{
	...
	unsigned char                                      UnknownData_EVEA[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEmissarySessionEndTelemetryEvent
{
	...
	unsigned char                                      UnknownData_ZN2B[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9LOK[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_S261[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FLightVisualisation
{
	...
	unsigned char                                      UnknownData_C4UM[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEmissaryLevelData
{
	...
	unsigned char                                      UnknownData_B0MN[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4SIJ[0x4];                                     // 0x0028(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UnknownData_OIXH[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
