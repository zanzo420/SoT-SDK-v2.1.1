...
{
public:
	unsigned char                                      UnknownData_RW4D[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EN0P[0xC8];                                    // 0x00C8(0x00C8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
