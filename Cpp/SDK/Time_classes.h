...
{
public:
	unsigned char                                      UnknownData_FFGY[0x38];                                    // 0x0430(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTimespan                                   GameWorldTimeOffset;                                       // 0x0468(0x0008) (Edit, ZeroConstructor, Config, DisableEditOnInstance, Protected)
	unsigned char                                      UnknownData_BQFZ[0x4];                                     // 0x0470(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EF60[0x4];                                     // 0x047C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XW6Z[0x4C];                                    // 0x04B4(0x004C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FReplicatedAuthoritativeTime                ReplicatedServerTime;                                      // 0x0500(0x0010) (BlueprintVisible, BlueprintReadOnly, Net, RepNotify)
	unsigned char                                      UnknownData_DOIM[0x30];                                    // 0x0510(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Z8VY[0x8];                                     // 0x0540(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IY8Z[0x8];                                     // 0x0548(0x0008) MISSED OFFSET (PADDING)
