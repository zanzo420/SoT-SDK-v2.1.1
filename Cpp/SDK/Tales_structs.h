...
{
	unsigned char                                      UnknownData_FV2R[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FTaleQuestCargoRunContractItem
{
	...
	unsigned char                                      UnknownData_NQ1H[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FTaleQuestDesc : public FQuestDesc
{
	...
	unsigned char                                      UnknownData_GNZP[0x20];                                    // 0x0038(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_4L4A[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (PADDING)
...
struct FTrackedActorData
{
	...
	unsigned char                                      UnknownData_52JY[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FCriticalActorDelegateData
{
	...
	unsigned char                                      UnknownData_TVB4[0x20];                                    // 0x0008(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_HMGW[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
{
	class AActor*                                      CriticalActor;                                             // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_GMDE[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
struct FPhasedItem
{
	...
	unsigned char                                      UnknownData_LUKE[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TTD0[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K45B[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FStepMerchantItemDesc
{
	...
	unsigned char                                      UnknownData_OXDO[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	struct FText                                       Name;                                                      // 0x0000(0x0018) ELEMENT_SIZE_MISMATCH (Edit, BlueprintVisible)
	unsigned char                                      UnknownData_LE2R[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	class UTexture*                                    Icon;                                                      // 0x0038(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
	struct FText                                       Name;                                                      // 0x0000(0x0018) ELEMENT_SIZE_MISMATCH (Edit, BlueprintVisible)
	unsigned char                                      UnknownData_XD57[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FTaleQuestDeliveryRequest
{
	...
	unsigned char                                      UnknownData_9PAQ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPhasedActor
{
	...
	unsigned char                                      UnknownData_YX00[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
