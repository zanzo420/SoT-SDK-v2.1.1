...
struct FStatus
{
	...
	unsigned char                                      UnknownData_862M[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_M7M2[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FDelayedStatusEffect
{
	...
	unsigned char                                      UnknownData_T5WO[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FActiveStatusEffect
{
	...
	unsigned char                                      UnknownData_JB96[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AYPS[0x17];                                    // 0x0039(0x0017) MISSED OFFSET (PADDING)
