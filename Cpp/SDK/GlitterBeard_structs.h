...
{
	unsigned char                                      UnknownData_1J8N[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8HD9[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_D8EZ[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VT05[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_99A0[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_06VF[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FFinaleReplicationState
{
	...
	unsigned char                                      UnknownData_4XQG[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FChangeGlitterBeardVFXStateEvent
{
	...
	unsigned char                                      UnknownData_EWY2[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
