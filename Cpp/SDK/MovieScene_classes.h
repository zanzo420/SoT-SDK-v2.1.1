...
public:
	...
	unsigned char                                      UnknownData_YWHP[0x48];                                    // 0x0038(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KW99[0x3];                                     // 0x00E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_L0UW[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FMovieSceneBindingOverrideData>      BindingData;                                               // 0x0030(0x0010) (Edit, ZeroConstructor)
	unsigned char                                      UnknownData_741X[0x58];                                    // 0x0040(0x0058) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_3W4V[0x10];                                    // 0x0060(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8AWB[0x368];                                   // 0x0028(0x0368) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LQ3Q[0x7];                                     // 0x03C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WZFH[0x10];                                    // 0x03E0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneSequencePlaybackSettings         PlaybackSettings;                                          // 0x03F0(0x0028) (Protected)
	unsigned char                                      UnknownData_2UHO[0x248];                                   // 0x0418(0x0248) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CUH6[0x2];                                     // 0x0082(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R77O[0x3];                                     // 0x0095(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_98P5[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SEW7[0x6];                                     // 0x02A2(0x0006) MISSED OFFSET (PADDING)
