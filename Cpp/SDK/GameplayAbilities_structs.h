...
struct FPredictionKey
{
	...
	unsigned char                                      UnknownData_5QEU[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UW3S[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (PADDING)
...
struct FActiveGameplayCue : public FFastArraySerializerItem
{
	...
	unsigned char                                      UnknownData_ZJ50[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FGameplayEffectModifiedAttribute
{
	...
	unsigned char                                      UnknownData_4I2J[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureDefinition
{
	...
	unsigned char                                      UnknownData_ZBMQ[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureSpec
{
	...
	unsigned char                                      UnknownData_GFT8[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureSpecContainer
{
	...
	unsigned char                                      UnknownData_NFGQ[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FTagContainerAggregator
{
	...
	unsigned char                                      UnknownData_F1DA[0x30];                                    // 0x0078(0x0030) MISSED OFFSET (PADDING)
...
struct FGameplayAbilitySpecDef
{
	...
	unsigned char                                      UnknownData_ZL8Z[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M5ZY[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_601Y[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FGameplayEffectSpec
{
	...
	unsigned char                                      UnknownData_4UJ2[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VU2H[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CQIB[0x3];                                     // 0x0215(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FGameplayAbilitySpecDef>             GrantedAbilitySpecs;                                       // 0x0218(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_LFPF[0x50];                                    // 0x0228(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JFBT[0x4];                                     // 0x029C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XSOK[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CZ0L[0x5B];                                    // 0x02D5(0x005B) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0GPY[0x50];                                    // 0x00A8(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FActiveGameplayEffect>               GameplayEffects_Internal;                                  // 0x00F8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_W0K4[0x2C0];                                   // 0x0108(0x02C0) MISSED OFFSET (PADDING)
...
struct FGameplayAbilityLocalAnimMontage
{
	...
	unsigned char                                      UnknownData_DG0A[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FPredictionKey                              PredictionKey;                                             // 0x0010(0x0018)
...
struct FGameplayAbilityRepAnimMontage
{
	...
	unsigned char                                      UnknownData_CBM1[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayAbilityActivationInfo
{
	...
	unsigned char                                      UnknownData_CK1U[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayAbilitySpec : public FFastArraySerializerItem
{
	...
	unsigned char                                      UnknownData_PQPJ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2DO5[0x5];                                     // 0x002B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_78T1[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (PADDING)
...
struct FGameplayAbilitySpecContainer : public FFastArraySerializer
{
	...
	unsigned char                                      UnknownData_4YEN[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (PADDING)
...
struct FAttributeMetaData : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_VX2L[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5O7C[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_V7YH[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MU7F[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XMIU[0x18];                                    // 0x0038(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G2GQ[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (PADDING)
...
struct FGameplayModifierEvaluatedData
{
	...
	unsigned char                                      UnknownData_1RXP[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VO0P[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CQ8V[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4EME[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4FUB[0xF];                                     // 0x0011(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_2EUM[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_5560[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGameplayAbilityTargetingLocationInfo       SourceLocation;                                            // 0x0010(0x0070) (Edit, BlueprintVisible, ContainsInstancedReference)
...
{
	unsigned char                                      UnknownData_E7RP[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LJPT[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y2MK[0x10];                                    // 0x00C0(0x0010) MISSED OFFSET (PADDING)
...
struct FGameplayAbilityBindInfo
{
	...
	unsigned char                                      UnknownData_7OME[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayEffectSpecForRPC
{
	...
	unsigned char                                      UnknownData_UQUM[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
struct FGameplayCuePendingExecute
{
	...
	unsigned char                                      UnknownData_4XX6[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayCueNotifyData
{
	...
	unsigned char                                      UnknownData_RITT[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
...
struct FGameplayEffectCustomExecutionOutput
{
	...
	unsigned char                                      UnknownData_NJ08[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OFIJ[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5I85[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FGameplayEventData
{
	...
	unsigned char                                      UnknownData_PG0L[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EFAG[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JME2[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X5O6[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ABXI[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FScalableFloat
{
	...
	unsigned char                                      UnknownData_ZDUX[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FCurveTableRowHandle                        Curve;                                                     // 0x0008(0x0010) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_OB87[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
struct FAttributeBasedFloat
{
	...
	unsigned char                                      UnknownData_A2EX[0x7];                                     // 0x0081(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayEffectModifierMagnitude
{
	...
	unsigned char                                      UnknownData_IUIF[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayModifierInfo
{
	...
	unsigned char                                      UnknownData_RN0T[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayEffectExecutionScopedModifierInfo
{
	...
	unsigned char                                      UnknownData_U4L4[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAbilityTriggerData
{
	...
	unsigned char                                      UnknownData_WRNE[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HSGB[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_5R8E[0x88];                                    // 0x0000(0x0088) MISSED OFFSET (PADDING)
