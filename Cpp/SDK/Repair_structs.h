...
{
	unsigned char                                      UnknownData_FJ7S[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventRepairableObjectRepairEndedEvent
{
	...
	unsigned char                                      UnknownData_AQLR[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_36A7[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
