...
{
	unsigned char                                      UnknownData_X5XN[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZXBJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HY40[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
