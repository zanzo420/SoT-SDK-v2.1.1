...
{
	unsigned char                                      UnknownData_ZGMO[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9KLA[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6IB7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FServerMigrationHeartbeatEvent
{
	...
	unsigned char                                      UnknownData_M60R[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GSQL[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XKZP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FBRR[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SBW4[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_332B[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
