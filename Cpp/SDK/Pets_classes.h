...
public:
	...
	unsigned char                                      UnknownData_5OCV[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
public:
	float                                              TaskDuration;                                              // 0x0088(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_U7DJ[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GANF[0x8];                                     // 0x0060(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QX79[0x2];                                     // 0x0062(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6Y06[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_79AX[0x3];                                     // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FHangoutSpotId                              ForcedId;                                                  // 0x008C(0x0008) (Edit)
	unsigned char                                      UnknownData_BMXJ[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FFLJ[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0BGG[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SJ55[0xD0];                                    // 0x00D0(0x00D0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RE0F[0x70];                                    // 0x00D8(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UClass*                                      PetType_Cached;                                            // 0x0148(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	unsigned char                                      UnknownData_EHH2[0x148];                                   // 0x0150(0x0148) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_05S9[0x20];                                    // 0x0950(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YYRW[0x4];                                     // 0x0984(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KYW0[0x8];                                     // 0x0998(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DBWV[0x4];                                     // 0x09D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FZVS[0x54];                                    // 0x09E4(0x0054) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZKI3[0x3];                                     // 0x02C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TOF3[0x3];                                     // 0x02C9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VRSJ[0x23];                                    // 0x02D5(0x0023) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UPetPerchComponent*>                  PetPerchComponents;                                        // 0x02F8(0x0010) (ExportObject, ZeroConstructor, ContainsInstancedReference)
	unsigned char                                      UnknownData_KL4J[0x10];                                    // 0x0308(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IDCS[0x1E];                                    // 0x031A(0x001E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2NRU[0x10];                                    // 0x0340(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FMPX[0x18];                                    // 0x0568(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T1TR[0x17];                                    // 0x05B1(0x0017) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DA4R[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_1ZY3[0x18];                                    // 0x0118(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LKUK[0x5];                                     // 0x015B(0x0005) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LI7M[0x4];                                     // 0x0038(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	unsigned char                                      UnknownData_8NVO[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LGBE[0x18];                                    // 0x0090(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1XTB[0x1A8];                                   // 0x0130(0x01A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B4C3[0x50];                                    // 0x02E0(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2HNW[0x30];                                    // 0x07D0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V79Z[0x4];                                     // 0x0804(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5NDP[0x6F];                                    // 0x0899(0x006F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_USTO[0x16];                                    // 0x090A(0x0016) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DJRF[0x10];                                    // 0x02E0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JPTY[0x80];                                    // 0x00D0(0x0080) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5PT0[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_993O[0x28];                                    // 0x00D0(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GLIO[0x50];                                    // 0x0128(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_TDQT[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
