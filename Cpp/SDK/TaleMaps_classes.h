...
{
public:
	unsigned char                                      UnknownData_70BH[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_3DN5[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Q98R[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_IMKW[0x30];                                    // 0x0078(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0AV2[0x48];                                    // 0x0068(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_U86N[0x40];                                    // 0x0068(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WU2R[0x30];                                    // 0x0068(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_VSK4[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (PADDING)
