...
{
	unsigned char                                      UnknownData_C7NE[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FShantyPuzzleInteractionZoneDefinition
{
	...
	unsigned char                                      UnknownData_I3V7[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_X8ZI[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FShantyPuzzleSingleInteractionZoneStopInteractingEvent
{
	...
	unsigned char                                      UnknownData_RQ4R[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FShantyPuzzleSingleInteractionZoneUnlockEvent
{
	class AActor*                                      Player;                                                    // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                InteractionZoneIdx;                                        // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_A7BW[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
