...
public:
	...
	unsigned char                                      UnknownData_G923[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FString                                     URL;                                                       // 0x0050(0x0010) (Edit, ZeroConstructor, Protected, HasGetValueTypeHash)
	unsigned char                                      UnknownData_N2XM[0xB8];                                    // 0x0060(0x00B8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JH4H[0x4];                                     // 0x021C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BMB4[0x30];                                    // 0x0228(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M8Q3[0x18];                                    // 0x0260(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_R35L[0x2];                                     // 0x013A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P111[0x8];                                     // 0x0158(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ITUT[0x40];                                    // 0x0168(0x0040) MISSED OFFSET (PADDING)
