...
struct FFoliageTypeObject
{
	...
	unsigned char                                      UnknownData_OS4L[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FProceduralFoliageInstance
{
	...
	unsigned char                                      UnknownData_U10W[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FP9M[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VDPD[0x20];                                    // 0x0040(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SG08[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
