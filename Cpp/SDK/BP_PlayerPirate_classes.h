...
{
public:
	unsigned char                                      UnknownData_UUQ9[0x8];                                     // 0x19C8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_2NSG[0x4];                                     // 0x1A64(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_63YR[0x3];                                     // 0x1A99(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
