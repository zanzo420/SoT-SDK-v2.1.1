...
public:
	...
	class UStaticMeshComponent*                        shp_mid_serving_hatch_L_01_a;                              // 0x05B8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MediumShip_ServingHatch_Left.BP_MediumShip_ServingHatch_Left_C");
		return ptr;
	}
